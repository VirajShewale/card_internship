...
return (
    <div class="min-h-screen bg-gradient-to-tr from-red-300 to-yellow-200 flex justify-center items-center py-20 w-screen">
      <div class="md:px-4 md:grid gap-5 space-y-4 md:space-y-0">
        <div class="max-w-sm bg-white px-6 pt-6 pb-2 rounded-xl shadow-lg transform hover:scale-105 transition duration-500">
          <h3 class="mb-3 text-xl font-bold text-indigo-600">{name}</h3>
          <div class="relative">
            <img class="w-full rounded-xl" src={image} alt="profile" />
            <p class="absolute top-0 bg-yellow-300 text-gray-800 font-semibold py-1 px-3 rounded-br-lg rounded-tl-lg">Top Player</p>
          </div>
          <h1 class="mt-4 text-gray-800 text-2xl font-bold cursor-pointer">Position: {position}</h1>
          <div class="my-4">
            <div class="flex space-x-1 items-center">
              ...
              <p>Points P/M: {stats.pointsPerGame}</p>
            </div>
            <div class="flex space-x-1 items-center">
              <span>
                <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 text-indigo-600 mb-1.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              ...
              <p>Assists P/M: {stats.assistsPerGame}</p>
            </div>
            <div class="flex space-x-1 items-center">
              <span>
                <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 text-indigo-600 mb-1.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              ...
              <p>Rebounds P/M: {stats.reboundsPerGame}</p>
            </div>
            <button class="mt-4 text-xl w-full text-white bg-indigo-600 py-2 rounded-xl shadow-lg">See More</button>
          </div>
        </div>
